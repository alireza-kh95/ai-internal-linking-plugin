...
$mixed_phrase = 'transformative benefits of IoT asset tracking';
$mixed = $insert->invoke( new AIL_Linker(), '<p>You have seen the transformative <strong>benefits of IoT asset tracking</strong> and you are ready.</p>', $mixed_phrase, $mixed_phrase, 'https://example.com/iot-benefits' );
verify( $mixed['changed'], 'A phrase split by bold inline markup must remain linkable.' );
verify( false !== strpos( $mixed['content'], '<a href="https://example.com/iot-benefits" data-ail="1">transformative <strong>benefits of IoT asset tracking</strong></a>' ), 'Mixed-format linking must preserve bold markup inside the anchor.' );
